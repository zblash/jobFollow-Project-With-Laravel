@extends('layouts.app')
@section('pageTitle', 'Randevu Ekle')
@section('css')
<style>
      html, body {
        height: 100%;
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <div class="box-body">
                  ...
                  <label for="exampleInputEmail1">Varolan Müşterilerden Seçin </label>
                
                  <select name="customer_id" id="customer_id" class="form-control customer-c" style="width: 100%;">
            ...
            <div class="form-group">
               ...
               <div class="form-group">
                  ...
                  <input type="text" name="service_pay" value="0" class="form-control" id="service_pay">
                  </div>
              </div>
              <div class="form-group">
                  ...
                  <input type="text" name="employee_pay" value="0" class="form-control" id="employee_pay">
                  </div>
              </div>
              <div class="form-group">
...
$('#pre-selected-optionss').multiSelect();
    $('.customer-c').on('change', function() {
      if(this.value != -1){
      $('.customer-d').fadeOut('slow');
      }else{
        $('.customer-d').fadeIn('slow');
      }
    })
