@extends('layouts.app')
@section('pageTitle', 'Planlı Randevu Düzenle')
@section('content')

<section class="content-header">
      <h1>
        Planlı Randevu Düzenle
      </h1>
      <ol class="breadcrumb">
        <li><a href=""><i class="fa fa-dashboard"></i> Anasayfa</a></li>
        <li><a href="">Müşteri İşlemleri</a></li>
        <li class="active">Planlı Randevu Düzenle</li>
      </ol>
    </section>
            ...
            <div class="form-group">
              ...
              <div class="form-group">
                ...
                <!-- /.input group -->
                  ...
                  <option value="">--------------</option>
                  @if($appointment->appointment_range == 1)
                  <option value="1" selected="selected">Günlük</option>
                  ...
                  @elseif($appointment->appointment_range == 5)
                  <option value="1">Günlük</option>
                  <option value="5" selected="selected">Beş Günde Bir</option>
                  <option value="7">Haftalık</option>
                  <option value="14">İki Haftada Bir</option>
                  <option value="30">Aylık</option>
                  @elseif($appointment->appointment_range == 7)
                  <option value="1">Günlük</option>
                  <option value="5">Beş Günde Bir</option>
                  <option value="7" selected="selected">Haftalık</option>
                  <option value="14">İki Haftada Bir</option>
                  <option value="30">Aylık</option>
                  @elseif($appointment->appointment_range == 14)
                  <option value="1">Günlük</option>
                  <option value="5">Beş Günde Bir</option>
                  <option value="7">Haftalık</option>
                  <option value="14" selected="selected">İki Haftada Bir</option>
                  <option value="30">Aylık</option>
                  @elseif($appointment->appointment_range == 30)
                  <option value="1">Günlük</option>
                  <option value="5">Beş Günde Bir</option>
                  <option value="7">Haftalık</option>
                  <option value="14">İki Haftada Bir</option>
                  <option value="30" selected="selected">Aylık</option>
                  @endif
                </select>
...
<script type="text/javascript">
 ...
 $("#postcontent").submit(function(e) {
        ...
        $.ajax({
            type:'POST',
            url:'{{ route('plannedappointmentEdit',$id) }}',
