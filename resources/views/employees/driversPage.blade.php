...
<section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="">Şoför İşlemleri</a></li>
        <li class="active">Şoförler</li>
      </ol>
    </section>
    <!-- Main content -->
...
<script>
  $(function () {
   $('#example1').on('click', '.btn-delete[data-remote]', function (e) { 
    ...
    // confirm then
    if (confirm('Şoför Silinsin mi? Eğer Silinirse Bağlı Olduğu Tüm Randevular da Silinecek')) {
        $.ajax({
            url: url,
            type: 'DELETE',
            dataType: 'json',
